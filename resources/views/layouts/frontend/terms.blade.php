        ...
        <div class="card">
            <div class="card-body">
                ...
                <ol>
                    ...
                    <li><a href="#tracking-technologies">Tracking Technologies</a></li>
                    <li><a href="#third-party-websites">Third-Party Websites</a></li>
                    <li><a href="#security-of-your-information">Security of Your Information</a></li>
                ...
                <ul>
                    <li><strong>Personal Data:</strong> Personally identifiable information, such as your name, email
                        address, and
                        telephone number, that you voluntarily give to us when you register with the Service or when you
                        choose to
                        participate in various activities related to the Service.</li>
                    ...
                    <li><strong>Financial Data:</strong> Financial information, such as data related to your payment method
                        (e.g.,
                        valid credit card number, card brand, expiration date) that we may collect when you purchase, order,
                        return,
                        exchange, or request information about our services from the Service.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Send you updates, marketing communications, and other information that may be of interest to you.
                    </li>
                ...
                <ul>
                    <li><strong>By Law or to Protect Rights:</strong> If we believe the release of information about you is
                        ...
                        required
                        by any applicable law, rule, or regulation.</li>
                ...
                <p>We may use cookies, web beacons, tracking pixels, and other tracking technologies on the Service to help
                    customize the Service and improve your experience. When you access the Service, your personal
                    information is not
                    collected through the use of tracking technology.</p>

                <h2 id="third-party-websites">Third-Party Websites</h2>
                <p>The Service may contain links to third-party websites and applications of interest, including
                    advertisements and
                    external services that are not affiliated with us. Once you leave the Service, any information you
                    provide to
                    these third parties is not covered by this privacy policy, and we cannot guarantee the safety and
                    privacy of
                    your information.</p>
                ...
                <p>We use administrative, technical, and physical security measures to help protect your personal
                    information. While
                    we have taken reasonable steps to secure the personal information you provide to us, please be aware
                    that no
                ...
                <p>If you wish to be informed about what Personal Data we hold about you and if you want it to be removed
                    from our
