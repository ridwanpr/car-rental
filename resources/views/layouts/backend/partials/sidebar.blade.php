...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner ps-2 me-2 pt-3">
        <div
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item {{ request()->routeIs('withdraw-request.index') ? 'active' : '' }}">
                <a href="{{ route('withdraw-request.index') }}" class="nav-link">
                    ...
                    <span class="sidebar-text">Withdraw Request</span>
                    @php
                        $withdrawRequests = \App\Models\Withdraw::where('status', 'pending')->count();
                    @endphp
                    <span
                        class="badge badge-sm bg-secondary ms-1 text-gray-800">{{ $withdrawRequests ? $withdrawRequests : '0' }}</span>
                </a>
            </li>
