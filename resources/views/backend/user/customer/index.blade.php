    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Manage Customer</h1>
                <p class="mb-0">Here is a list of all Customer. You can add, edit or delete Customer.</p>
            </div>
        </div>
    </div>
                    ...
                    <tbody>
                        @foreach ($customers as $customer)
                            <tr>
                                ...
                                <td>{{ $customer->user_details->phone ?? '-' }}</td>
                                <td>{{ $customer->user_details->balance ?? '-' }}</td>
                                <td>
